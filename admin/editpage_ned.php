...
// if everything is ok, try to upload file
	...
	$mysqli->query("UPDATE pages SET pageTitle='$title', pageCont='$content', image='$newfilename'WHERE pageID='$pageID'");
...
<div id="navigation">
<ul class="menu">
<li><a href="<?php echo DIRADMIN;?>?lang=dutch">Back</a></li>
